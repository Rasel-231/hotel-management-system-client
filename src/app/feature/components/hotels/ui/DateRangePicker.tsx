      ...
      >
        <Calendar
          ...
          classNames={{
            ...
            month: "gap-1",
            month_caption:
              "h-8 justify-center text-sm font-semibold text-forest",
            dropdowns: "h-8 text-sm font-semibold text-forest",
            weekday:
              "text-[11px] font-bold uppercase tracking-wide text-caption py-1",
            today:
              "text-gold font-bold after:absolute after:bottom-0.5 after:left-1/2 after:-translate-x-1/2 after:h-[2px] after:w-4 after:bg-gold",
          }}
