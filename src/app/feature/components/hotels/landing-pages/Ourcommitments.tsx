...
import { Globe2, Leaf, HeartHandshake, ShieldCheck } from "lucide-react";
  ...
  return (
    <section className="w-full py-8 sm:py-12 lg:py-16">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        ...
        <div className="relative mt-8 overflow-hidden rounded-sm  px-6 py-2 sm:px-12 sm:py-7 ring-1 ring-line">
          ...
          <div className="relative z-10 mt-10 grid grid-cols-3 gap-6 sm:mt-12 sm:gap-6">
            {commitments.map(({ icon: Icon, title, subtitle }) => (
              ...
              >
                ...
                <p className="mt-1 text-xs text-caption sm:text-sm">
                  {subtitle}
                </p>
              </div>
            ))}
